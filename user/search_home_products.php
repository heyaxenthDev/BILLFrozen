...
if ($query !== '') {
    $sql = "SELECT pl.product_name, pl.category, pl.price, pl.product_picture, inv.quantity, inv.product_code 
            ...
            WHERE inv.quantity > 0 AND (pl.product_name LIKE ? OR pl.category LIKE ? ) LIMIT 4";
...
if ($result && $result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<img src="\BillFrozen/admin/' . $row['product_picture'] . '" class="card-img-top" alt="...">';

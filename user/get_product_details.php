...
if (isset($_GET['product_id'])) {
    ...
    $sql = "SELECT pl.product_name, pl.description, pl.category, pl.price, pl.product_picture, inv.quantity, inv.product_code, inv.expiry_date
    ...
    // Return error if product_id is missing

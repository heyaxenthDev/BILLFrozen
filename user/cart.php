                ...
                JOIN inventory i ON c.product_code = i.product_code";
                    ...
                    ?>
                            ...
                            <div class="d-none d-md-block card mb-3">
                                <div class="row g-0 align-items-center">
                                    ...
                                    <div class="col-md-1 col-1">
                                        <div class="cart-body">
                                            <a href="#" class="text-danger cart" data-product-code="<?= $row['product_code'] ?>"><i class="bi bi-trash-fill"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- End cart item -->
                            ...
                            <div class="d-md-none card mb-3 position-relative">
                                <a href="#" class="text-danger cart position-absolute top-0 end-0 p-3" data-product-code="<?= $row['product_code'] ?>"><i class="bi bi-trash-fill"></i></a>
                                <div class="row g-0 align-items-center">
                                    <div class="col-3">
                                        <img src="<?= $src . $row['product_picture'] ?>" class="img-fluid rounded-start cart-img" alt="...">
                                    </div>
                ...
                <div class="summary col-md-4 d-none d-md-block">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-lg btn-block text-white" name="checkOutBtn" style="background-color: #0f1b48;">
                                Go to checkout
                            </button>
                        </div>
                    </div>
                ...
                <nav class="navbar fixed-bottom d-md-none d-block" style="background-color: #fff394;">
                    <div class="container-fluid d-flex justify-content-center">
                        <div class="row w-100">
                            ...
                            <div class="col-6 d-flex justify-content-center align-items-center">
                                <button type="submit" class="btn btn-md btn-block text-white" name="checkOutBtn" style="background-color: #0f1b48;">
                                    Go to checkout
                                </button>
                            </div>
                        </div>

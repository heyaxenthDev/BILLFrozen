...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2025 at 10:46 AM
...
INSERT INTO `admin` (`id`, `account_name`, `account_password`, `password_token`, `email`, `created_at`) VALUES
(1, 'Admin', '$2y$10$NFyVOgayO3pSw9SW3hVfiuTAavYlhfsRW3awETusMdpi0QC01FdfW', '', 'billfrozen2025@gmail.com', '2025-05-17 08:43:46'),
(2, 'Sub Admin', '$2y$10$/yWeEQK602kEuX634revAeL8u45Dx4zyVooDxvRhni3JT.fR8iI4G', '', 'billfrozen2025@gmail.com', '2025-05-17 08:43:46');
...
(5, 'BFU342966', 'Hya Cynth Dojillo', 'Your order with order code ORD02-06-20259914 has been declined. Reason: asjdjasd', 'Order Declined', 'read', '2025-05-15 17:50:37');
...
('ORD02-06-20259914', 'BFU342966', 'Hya Cynth Dojillo', '09651168472', 'PROD863845', 'Pampanga`s Best - Sisig', 1, 81.00, '2025-02-07', NULL, 'dakjd, jdasd, 5456', 'Order Declined', '2025-02-06 17:03:01');
...
(1, 'Magnolia Whole Chicken', 'sadas', 'Dressed Chicken', 230.00, 'uploads/SM3012-4.jpg'),
...
INSERT INTO `users` (`id`, `user_id`, `email_or_phone_number`, `full_name`, `username`, `password`, `password_token`, `verify_email`, `profile_picture`, `date_created`) VALUES
(1, 'BFU342966', 'hyacynthd.socialmail@gmail.com', 'Hya Cynth Dojillo', 'hyacynth', '$2y$10$2p5wxraNLddTrR1WrdxmNuTzzQpxhZ2ctv.db7DRNIoF0rkqOKIjq', '', 0, NULL, '2024-03-21 06:18:48'),
(2, 'BFU509265', 'hyacynth.mulaveintern@gmail.com', 'Hya Cynth Dojillo', 'yangyang', '$2y$10$3O0tM.ugft11w2yTxu/1a.h5QwFB5wg3RGRjYZcCIT7U0bOqD84zC', '476949', 0, NULL, '2024-06-18 02:22:22'),
(3, 'BFU669727', 'ghelobatas@gmail.com', 'Ghelo Batas', 'gheloB', '$2y$10$259IFp2aOI9v/IhNzV09fOYXCI.rV0S999DvrLHcRxP6Ynxrtg3vi', '476949', 0, NULL, '2025-02-04 06:28:22');

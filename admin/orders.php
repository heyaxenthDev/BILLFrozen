                    ...
                    <div class="card-body">
                        ...
                        <table id="ordersTable" class="table datatable">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT order_code, user_id, SUM(quantity) as total_quantity, SUM(total_price) AS grand_total, order_date, delivery_date, delivery_address, order_status FROM orders WHERE order_status != 'Order Declined' GROUP BY order_code ORDER BY date_created DESC";
                ...
                <div class="modal-content">
                    ...
                    <form action="code.php" method="POST">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger btn-sm" id="openDeclineModalBtn"
                                name="declineBtn">Decline
                                Order</button>
                            ...
                            <!-- Print Modal Button -->
                            <button id="print-view-modal" onclick="printOrderModal()" class="btn btn-secondary btn-sm">
                    ...
                    <form id="declineReasonForm" method="POST" action="code.php">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="decline_reason" name="decline_reason" rows="3"
                                    required></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
